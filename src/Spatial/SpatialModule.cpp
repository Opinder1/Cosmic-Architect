...
namespace voxel_game
{
	...
	{
		world.system<SpatialWorldComponent>("SpatialWorldLoaderSystem")
			.multi_threaded()
			.each([](flecs::entity& entity, SpatialWorldThreadComponent* world_thread)
		{
		...
		world.system<SpatialWorldComponent>("SpatialWorldFlushCommandsSystem")
			.multi_threaded()
			.each([](flecs::entity& entity, SpatialWorldComponent* spatial_world)
		{
